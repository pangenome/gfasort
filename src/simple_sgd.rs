//! Simple SGD - Edge-based stochastic gradient descent
//!
//! This is a simpler SGD variant that tries to place connected nodes close
//! together based on edge relationships, without using path guidance.
//! Useful for graphs without paths.
...
impl SimpleSGD {
    ...
    pub fn run(&self) -> HashMap<usize, f64> {
        ...
        // Learning rate
        let eta = Arc::new(AtomicU64::new(f64_to_u64(1.0)));
        let delta_max = Arc::new(AtomicU64::new(f64_to_u64(f64::MAX)));
    ...
    fn initialize_positions(&self) -> HashMap<usize, AtomicU64> {

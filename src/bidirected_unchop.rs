//! Bidirected unchop - properly handles all orientations for merging linear chains
//!
//! This module provides unchop functionality for HashGraph (handlegraph) types.
        ...
        if created_nodes.insert(new_id) {
            ...
            for &handle in chain {
                ...
                if handle.is_reverse() {
                    ...
                    seq.extend(reverse_complement(&fwd_seq));
                } else {
